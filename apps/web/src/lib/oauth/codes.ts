...
export async function mintAuthorizationCode(db: SupabaseClient, input: MintAuthorizationCodeInput): Promise<string> {
...
/** One-time-use, PKCE-verified. The conditional UPDATE (`used_at is null`)
 * is the concurrency guard — a replayed code can only win once. */
