// RFC 6749 §5.2-shaped error responses for the OAuth endpoints — OAuth
// clients parse `error` as one of a fixed set of machine-readable codes,
// not prose. Shape copied from Pulse's src/lib/oauth/respond.ts.
